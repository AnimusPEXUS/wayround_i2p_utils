...
def str_to_datetime(value):
    ...
    if re_res:
        ...
        tzinfo = wayround_i2p.utils.datetime_iso8601.gen_tz(
...
def datetime_to_str(value, attrs=None):
    ...
    zone = wayround_i2p.utils.datetime_iso8601.format_tz(
        value.tzinfo,
        sep=False
        )
    ...
    for value in tests:
        ...
        if re_res:
            ...
            print(
                "    {:20}: {}".format(
                    'iso8601',
                    wayround_i2p.utils.datetime_iso8601.datetime_to_str(
                        dt
                        )
                    )
                )
