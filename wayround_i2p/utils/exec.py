...
def test_pipes():
    ...
    cat1 = wayround_i2p.utils.stream.cat(
        txt,
        xz1.stdin,
        threaded=True,
        close_output_on_eof=True,
    ...
    cat2 = wayround_i2p.utils.stream.cat(
        xz4.stdout,
        sys.stdout,
        threaded=True,
    ...
    def start(self):
        ...
        if ret == 0:
            ...
            try:
                ...
                self.in_cat = wayround_i2p.utils.stream.cat(
                    self.stdin,
                    self.proc.stdin,
                    threaded=True,
                ...
                self.out_cat = wayround_i2p.utils.stream.cat(
                    self.proc.stdout,
                    self.stdout,
                    threaded=True,
