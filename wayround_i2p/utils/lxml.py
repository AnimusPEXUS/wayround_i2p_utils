...
def simple_exchange_class_factory(
    ...
    see wayround_i2p.xmpp.xcard_4 for example usage
    ...
    --
    You can use
    wayround_i2p.utils.factory.class_generate_attributes_and_check()
...
def new_from_element(cls, element):
    ...
    int_tag = wayround_i2p.utils.lxml.parse_element_tag(
        element,
        '{tag}',
        '{namespace}'
        )[0]
    ...
    cl = cls(**wayround_i2p.utils.lxml.\
        generate_initial_parameters_for_constructors(cls, element))

    {gw1}

    wayround_i2p.utils.lxml.subelems_to_object_props2(
        element, cl,
...
def gen_element(self):
    ...
    wayround_i2p.utils.lxml.object_props_to_subelems2(
        self, el,
